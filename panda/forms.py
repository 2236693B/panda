...
class ContactForm(forms.Form):
    ...
    def message(self):
        #renders body of message to a string
    ...
    def subject(self):
        #renders subject of message to a string
    ...
    def get_context(self):
        #returns context used to render to templates for 
		#email and subject body.
    ...
    def get_message_dict(self):
        #generate various parts of message and return them in a
		#dictionary, for passing as keyword arguments to django.core.mail.send_mail()
        if not self.is_valid():
            raise ValueError(
